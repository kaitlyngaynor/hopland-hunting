...
# combine into one
collar_data_all <- do.call("rbind", extracted.list) 

# add the metadata
collar_data_all <- left_join(collar_data_all, metadata)

# create spatial data frame, transform to UTM, and crop to HREC huntable zone
igotu_spdf <- collar_data_all # copy
